...
Shopify.Image = {
  ...
  switchImage: function (image, element, callback) {
    ...
    if (callback) {
      ...
      var replacementImg = document.querySelector('img[data-image-id="'+image.id+'"]');
      
      if (replacementImg == element) {
        if (typeof element.dataset.origSrcset != 'undefined') { 
			element.srcset = element.dataset.origSrcset;
        }
      } else {
        if (typeof replacementImg.srcset != 'undefined') { 
        	element.srcset = replacementImg.srcset;
        }
      }
